...
- `unreadCount: Ref<number>` — unread count (§4.3): incremented while the session page is hidden (`markSessionHidden()`), cleared by `markSessionVisible()`; agent/AI content only
