...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/models.AgentGroup"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/agents/groups/{id}/members": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "成员用户 ID 全量列表",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.ReplaceGroupMembersRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/agents/stats": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "特定客服ID，用于获取单个客服的统计",
                        "name": "agent_id",
                        "in": "query"
                    }
                ],
        ...
        "/api/remote-assist/annotations/{id}": {
            "delete": {
                "produces": [
                    "application/json"
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.StartAssistRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/remote-assist/sessions/{id}/annotations": {
            "get": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AddAnnotationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/remote-assist/sessions/{id}/end": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.EndAssistRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.CustomerSatisfaction"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/satisfactions/surveys/{id}/resend": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.SatisfactionSurvey"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/session-transfer/check-auto": {
            "post": {
        ...
        "/api/session-transfer/history/{session_id}": {
            "get": {
        ...
        "/api/session-transfer/process-queue": {
            "post": {
        ...
        "/api/session-transfer/waiting": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "waiting/transferred/cancelled",
                        "name": "status",
                        "in": "query"
                    },
                    {
        ...
        "/api/sla/check/ticket/{ticket_id}": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "SLA违约信息（如有）",
                        "schema": {
                            "$ref": "#/definitions/models.SLAViolation"
                        }
                    },
                    "204": {
                        "description": "无SLA违约"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application.SLAConfigCreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "创建成功",
                        "schema": {
                            "$ref": "#/definitions/models.SLAConfig"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
        ...
        "/api/sla/configs/priority/{priority}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "客户等级（可选，匹配具体等级，否则返回默认配置）",
                        "name": "customer_tier",
                        "in": "query"
                    }
                ],
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application.SLAConfigUpdateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "SLA统计数据",
                        "schema": {
                            "$ref": "#/definitions/application.SLAStatsResponse"
                        }
                    },
                    "500": {
                        "description": "服务器错误",
        ...
        "/api/statistics/customer-source": {
            "get": {
        ...
        "/api/statistics/ticket-priority": {
            "get": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/contract.CreateTicketRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/contract.BulkUpdateTicketRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/contract.BulkUpdateResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/tickets/export": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "最多导出条数（默认 1000，最大 5000）",
                        "name": "limit",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/contract.TicketStats"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/contract.UpdateTicketRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/tickets/{ticket_id}/satisfaction": {
            "get": {
        ...
        "/api/v1/auth/2fa/disable": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Account password and authenticator or recovery code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.twoFactorDisableRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/auth/2fa/enable": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Secret from setup and authenticator code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.twoFactorEnableRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.twoFactorRegenerateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/auth/2fa/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Challenge token and authenticator or recovery code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.twoFactorVerifyRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.GuestSessionRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.GuestSessionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/remote-assist/{id}/consent": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.RespondConsentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AttachRecordingRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/sessions/{session_id}/messages": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "游标：晚于此消息 ID 的增量；空=从会话头拉全量",
                        "name": "after_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "单页上限（默认 50，最大 200）",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/delivery.VisitorMessagesPage"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/contract.CreateVisitorTicketRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.TranslationPreferenceRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "application.ConversationMessageDTO": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
        ...
        "application.SLAConfigCreateRequest": {
            "type": "object",
            "required": [
                "escalation_time",
                "first_response_time",
        ...
        "application.SLAConfigUpdateRequest": {
            "type": "object",
            "properties": {
                "active": {
                    "type": "boolean"
        ...
        "application.SLAStatsResponse": {
            ...
            "properties": {
                ...
                "trend_data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/application.SLAComplianceTrend"
                    }
                },
        ...
        "contract.BulkUpdateResult": {
            "type": "object",
            "properties": {
                "failed": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/contract.BulkUpdateFailure"
                    }
                },
                "updated": {
                    "type": "array",
        ...
        "contract.BulkUpdateTicketRequest": {
            "type": "object",
            "required": [
                "ticket_ids"
            ],
        ...
        "contract.CreateVisitorTicketRequest": {
            "type": "object",
            "required": [
                "session_id",
                "title"
        ...
        "contract.TicketStats": {
            ...
            "properties": {
                "by_priority": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/contract.PriorityCount"
                    }
                },
                "by_status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/contract.StatusCount"
                    }
                },
                "pending": {
                    "type": "integer"
        ...
        "delivery.VisitorMessagesPage": {
            ...
            "properties": {
                ...
                "messages": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/application.ConversationMessageDTO"
                    }
                }
            }
        },
        ...
        "handlers.AttachRecordingRequest": {
            "type": "object",
            "required": [
                "recording_key"
            ],
            "properties": {
                ...
                "recording_key": {
                    "type": "string",
                    "example": "uploads/2026/09/rec-abc.webm"
                },
                "recording_mime": {
                    "type": "string",
                    "example": "video/webm"
        ...
        "handlers.EndAssistRequest": {
            "type": "object",
            "properties": {
                "outcome": {
                    "description": "ended|failed",
                    "type": "string",
                    "example": "ended"
                },
                "recording_duration_ms": {
        ...
        "handlers.ReplaceGroupMembersRequest": {
            "type": "object",
            "properties": {
                "member_ids": {
                    "description": "坐席用户 ID 全量列表",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
        ...
        "handlers.RespondConsentRequest": {
            "type": "object",
            "properties": {
                "accept": {
                    "type": "boolean",
        ...
        "handlers.TranslationPreferenceRequest": {
            "type": "object",
            "required": [
                "target_lang"
            ],
        ...
        "handlers.twoFactorDisableRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "handlers.twoFactorEnableRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "handlers.twoFactorRegenerateRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "handlers.twoFactorVerifyRequest": {
            "type": "object",
            "properties": {
                "challenge_token": {
                    "type": "string"
        ...
        "models.CustomField": {
            ...
            "properties": {
                ...
                "options_json": {
                    "description": "JSON array (for select/multiselect)",
                    "type": "string"
                },
                "required": {
                    "type": "boolean"
        ...
        "models.Customer": {
            ...
            "properties": {
                ...
                "source": {
                    "description": "web, referral, marketing",
                    "type": "string"
                },
                "tags": {
                    "description": "标签，逗号分隔",
        ...
        "models.SatisfactionSurvey": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "queued, sent, completed, expired",
                    "type": "string"
                },
                "survey_token": {
                    "type": "string"
        ...
        "models.Session": {
            ...
            "properties": {
                ...
                "platform": {
                    "description": "web, telegram, wechat, etc.",
                    "type": "string"
                },
                "started_at": {
                    "type": "string"
        ...
        "models.Ticket": {
            ...
            "properties": {
                ...
                "ai_summary": {
                    "description": "访客工单创建时的 AI 会话摘要（M3 §10 #4）",
                    "type": "string"
                },
                "attachments": {
                    "type": "array",
                ...
                "category": {
                    "description": "technical, billing, general, complaint",
                    "type": "string"
                },
                "closed_at": {
                    "type": "string"
                ...
                "custom_field_values": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TicketCustomFieldValue"
                    }
                },
                "customer": {
                    "description": "关联关系",
                ...
                "source": {
                    "description": "web, email, phone, chat",
                    "type": "string"
                },
                "status": {
        ...
        "models.TicketComment": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "comment, internal_note, system",
                    "type": "string"
                },
                "user": {
                    "$ref": "#/definitions/models.User"
