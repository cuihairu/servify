...
- 当前优先恢复任务：按用户指示推进下一项。P2-5 四刀全部闭环（第一刀公开接口运行时安全基线、第二刀 auth 审计与登录风险执行、第三刀 refresh reuse 家族吊销、第四刀审批回滚链路真实验收，见 P2-5 进展），"对应安全面能力均有真实验收"的验收标准达成；下一步候选 P2-6 管理端产品化收尾
